...
class airSuckUtil:
    ...
    def modeA2Meta(self, aSquawk, region):
        ...
        if region == self.regionUSA:
            ...
            elif ((aInt >= 500) and (aInt <= 1100)) or ((aInt >= 1300) and (aInt <= 4177)) or ((aInt >= 5600) and (aInt <= 6077)) or ((aInt >= 6200) and (aInt <= 6377)) or ((aInt >= 6500) and (aInt <= 7077)) or ((aInt >= 7100) and (aInt <= 7377)) or ((aInt >= 7610) and (aInt <= 7677)) or ((aInt >= 7710) and (aInt <= 7776)):
