...
from aisConnector import dataSource
from pprint import pprint
import binascii

# Since some frames are fragments we need to use a stateful system to handle them...
aisProc = dataSource('testParser', None, False)
